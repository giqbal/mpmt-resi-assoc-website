    ...
    <nav className="navbar is-dark is-spaced" role="navigation">
      <div className="navbar-brand">
        <a className="flex" href="/">
          <span className="subtitle is-2 has-text-grey has-text-weight-light">
            MPMT
          </span>
          <span className="subtitle is-2 has-text-white has-text-weight-light">
            SALFORD
          </span>
        </a>
        ...
        <a
          role="button"
          className={`navbar-burger ${drawerState}`}
          aria-label="menu"
